...
public class String_Method {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.length()); 		// 13자 
		...
		System.out.println(str1.lastIndexOf('a')); //마지막 a가 저장된 방번호 9
	...
	//	String str4 = true;				//boolean 타입을 String 변수에 저장시 오류 발생
	    ...
	    //substring ( 0 , 5 ) : 0 번방에서부터 5번방까지 잘라서 출력
	    System.out.println(str13.substring(0,5)); // 0번에서 시작해서 5번 방 앞까지 짤림
	    	//모든 프로그램에서 시작은 포함, 끝은 미포함 (0은 포함, 5는 미포함)
	    ...
	    System.out.println(str21.equals(str22));  	//false( 대소문자 비교하기 때문이다!)
