	...
	public static void main(String[] args) {
		/*
		  ...
		  배열 - 하나의 배열 변수에 많은 값을 저장할 수 있다. 
		      - 배열의 특징 : 1. 배열변수의 동일한 사료형의 값만 저장할 수 있다. (int, long, double)
		      			   2. 배열은 방의 갯수가 정의 되면 수정이불가능	
		      - 배열은 초기값을 할당하지 않더라도 강제로 초기값이 할당됨.
		...
		// 변수를 선언후 초기값을 할당하지 않고 사용하면 오류 발생
		int c ;
		int d ;
		...
		// int[] : 정수 값만 배열에 저장 가능
		// array1 : 배열 변수 , array 1 변수 명은 stack 공간에 저장이되고, array1에 Heap 영역의 주소값이 저장
		...
		array3[2] = 30;
		array3[3] = 40;
		//array3[4] = 50;		// 오류 : 예외 발생 (방의 개수는 4개인데 5개째 만드니까 오류남)
		...
		//int [] array6 = new int[5] { 10,20,30,40,50 }; 
			// 오류 발생 : 선언과 동시에 배열 변수에 값을 할당할 때 방크기를 지정하면 오류 발생
		...
		//System.out.println(array7[6]); // 오류발생 (실행시 오류발생)
			//ArrayIndexOutOfBoundsExceaption : 배열의 방의 크기를 넘어가면 발생되는 오류
		...
		// array9 = new int [] {111,222,333,444,555};  // 이렇게 해야 오류발생되지 않음.
