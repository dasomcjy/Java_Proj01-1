...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" =====For 문을 사용해서 배열의 각 방의 내용르 출력=====  ");
		for ( int i = 0 ; i < arr1.length; i ++ ) {  //만약 i++ 아니고 i+=2 이렇게 하면 짝수 방만 출력
		...
		System.out.println(" =====Arrays.toString(arr1)을 사용해서 배열의 각 방의 내용르 출력=====  ");
