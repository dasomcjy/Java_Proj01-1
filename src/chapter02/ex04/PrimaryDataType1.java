...
public class PrimaryDataType1 {
	...
	public static void main(String[] args) {
		...
		//  - 기본 자료형 : boolean, byte, short, int, long, double, char 
		...
		// 2. 정수 (byte : 1byte, short : 2byte, int : 4byte, long:8byte)
		 ...
		 System.out.println(value6);
		    ...
		    //long : 8byte = 64bit : -2^63 ~ 2^63-1
		         // long 의 변수에 값을 할당할 때에는 l, L을 붙여줘야 한다.
		...
		// 3. 실수 (float : 정밀도 7자리 (4byte) , double : 정밀도 15자리(8yte))
               //실수의 기본은 double
		 
		       //float : float 으로 지정된 변수의  값을 할당할 때 리터럴에 f, F 명시를 해야 한다.
		...
		// 4. 문자 (char) : 영문/한글/일본어/ ...., 숫자, 특주문자 한 글자
		//        변수의 값을 할당할 리터럴에 '  '
