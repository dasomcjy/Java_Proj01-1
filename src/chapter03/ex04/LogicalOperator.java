...
public class LogicalOperator {
	...
	public static void main(String[] args) {
		...
		//3. 쇼트 서킷 : 논리연산자에서 앞의 내용으로 뒤의 값의 유무없이 식별 가능 하면 뒤의 값은 처리하지 않음
		...
		System.out.println(value1);		// 3 (3이 찍힌다는 것은 뒤의 명령어 ++을 실행하지 않았다는 것!)
		...
		int value4 = 3;
		System.out.println(false | ++value4 > 6); //쇼트 서킷이 발생 안됨 (비트연산자 : | )
