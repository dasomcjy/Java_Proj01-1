...
class C {
	...
	static int b = 20;		//정적 필드 : 객체화하지 않고 사용가능,
									//모든 객체에서 공유되는 변수
								//메모리의 클래스 영역에 변수의 값을 저장 , Heap 영역에는
								// 클래스 영역에 저장된 주소 값만 가진다.
	void print1() {
		System.out.println(a + " " + b);
	}
	static void print2 () {		// 정적 메소드에는 인스턴스 필드가 올 수 없다. 정적필드만 올수 있음 a : 인스턴스 필드
...
public class Instance_VS_Static02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(c1.a);		//인스턴스 필드 : 다른 객체와는 분리된 고유공간
