...
class MethodOverloading {
	...
	//메소드 오버로딩 : 동일한 이름의 메소드이지만 시그니쳐에 따라서 다른 메소드를 호출한느곳
...
public class Method_Overloading {
	...
	public static void main(String[] args) {
		// 메소드 오버로딩 : 동일한 이름의 메소드를 시그니쳐에 따라서다른 메소드를 호출하는 것
		//		  시그니쳐 : 메소드의 인풋 매개변수 갯수, 인풋되는 타입이 다를경우 다른 메소드로 식별
		// 메소드 오버라이딩 : 상속에서만 적용됨
				//부모클래서에서 선언된 메소드를 자식클래스에서 재정의해서 사용하는것
