...
public class If_Controll_statement {
	...
	public static void main(String[] args) {
		...
		//1. type 1  :  if (조건)  { 실행문 : 조건이 참일때 실행; }
			// {} 를 생략 가능한데, 생략될 경우 실행문 1개만 적용(;하나까지만!)
		...
		//2. type 3 : if (조건) { 조건이 참일때 실행 ; } else { 조건이 거짓일때 실행; }
			// 삼항 연산자로 변환
	...
	System.out.println("======삼항 연산자를 사용해서 출럭 =======");
	...
	if (value3 >= 70 ) {			//실행후 탈출 => B학점이지만 C학점의 범위 먼저 진행되어 C학점으로 출력됨
		System.out.println("C 학점");
	}else if (value3 >=80) {
