...
public class Method_Overriding02 {
	...
	public static void main(String[] args) {
		...
		// 메소드 오버라이딩, 오버라이딩된 메소드 출력...//오버라이딩은 상속관계에서만 사용가능
		// Animal의 메소드 호출시 오버라이딩된 자식의 메소드가 출력 
		t1.animalSound();   //Animal 의 animalSound 호출시 , Tiger의 animalSound 가 출력
		t2.animalSound();   //Animal 의 animalSound 호출시 , Lion의 animalSound 가 출력
		t3.animalSound();	//Animal 의 animalSound 호출시 , Eagle의 animalSound 가 출력
		t4.animalSound();	//Animal 의 animalSound 호출시 , Lion의 animalSound 가 출력
