...
class TigerChild extends Tiger{
	...
	void tigerChildEat() {
		System.out.println("아기 호랑이는 밥을 먹습니다.");
	}
}
...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		// 
		// 다운 캐스팅 : 실행시 오류 발생, t3에는 TigerChild는 내포하지 않기 때문에 
				//다운캐스팅시 오류발생
		...
		// 다운 캐스팅 할때는 반드시 instanceof를 사용해야 한다. 아니면 실행할때 오류발생
		...
		//t6는 (TigerChild) ---> Animal
		
		Animal t7 =  t6;	//t7 : Animal, Tiger, TigerChild 내포하고 있고 Animal 타입
		Tiger t8 = t6;		//t5 : Animal, Tiger, TigerChild 내포하고 있고 Tiger 타입
