...
public class ConsoleOutput {
	...
	public static void main(String[] args) {
		...
		//변수선언 : 자료형 변수명 = 변수의 값
		int a = 5;     // 정수형 a 변수에 정수값 5를 넣어라  int>정수를 넣어라
		...
		// %d   :   뒤의 정수를 불러올 때 사용 (문자열 내에서 뒤에있는 정수를 가지고 올때 (10진수)
        ...
        System.out.printf("%s 은 %s가 매우매우 %s 니다", "오늘", "날씨", "맑습");
        
        //%f : 문자열 뒤의 실수 값 불러올때 사용
        //%4.2f : 4 : 전체 4자리, 2소숫점이하 2자리까지 잘라서 출력    
        System.out.printf("나의 몸무게는 %f입니다 \n", 75.1234567);
        System.out.printf("나의 몸무게는 %4.2f", 75.1234567);
